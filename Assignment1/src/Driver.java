...
public class Driver {
	...
	private final  String prophetMessage="Congratulations! You make a correct prediction for the result!";
	private  Officer[] referee;
	private  Althlete[] athleteData;
	private  Game[] games;
	private  boolean haveChosenGame;
	private  boolean haveSelectedWinner;
	private  boolean predictRightly=false;
	private  boolean exit=true;
	private  Random random;
	private  int[] participants;
	private  int[] currentGameResults;
